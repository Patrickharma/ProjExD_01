...
def main():
    ...
    bird_imgs = [bird_img, pg.transform.rotozoom(bird_img, 1, 1.0),pg.transform.rotozoom(bird_img, 2, 1.0),pg.transform.rotozoom(bird_img, 3, 1.0),pg.transform.rotozoom(bird_img, 4, 1.0),pg.transform.rotozoom(bird_img, 5, 1.0),pg.transform.rotozoom(bird_img, 6, 1.0),pg.transform.rotozoom(bird_img, 7, 1.0),pg.transform.rotozoom(bird_img, 8, 1.0),pg.transform.rotozoom(bird_img, 9, 1.0), pg.transform.rotozoom(bird_img, 10, 1.0)]
    ...
    while True:
        ...
        screen.blit(bird_imgs[tmr%10], bird_rct)
        print(tmr%10)
        pg.display.update()
        tmr += 1        
        clock.tick(50)
